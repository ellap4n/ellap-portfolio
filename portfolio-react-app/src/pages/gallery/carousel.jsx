...
const GALLERY_ITEMS = [
    ...
    { img: sun, alt: 'Memos from Taiwan', title: 'Memos from Taiwan', medium: 'Analogue Photography', artdate: 'January 2025', artdescription: 'Taiwan from my perspective' },
    { img: fmmart, alt: 'Memos from Shikoku', title: 'Memos from Shikoku', medium: 'Analogue Photography', artdate: 'January 2025', artdescription: 'Japan, away from the metropolis' },
];
